...
#define STRING_CONFIG_H_AUTHOR "@sbelljr" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3D V6 with sock, 30W, Effector 5015x2
...
#define DELTA
  ...
  // #define DELTA_HOME_TO_SAFE_ZONE // enabled crashes on tall print finish
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 20 } //TODO is this causing crashes on filament change?
